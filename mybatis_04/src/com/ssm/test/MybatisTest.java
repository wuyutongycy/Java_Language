...
//        user.setUname("田七");
//        user.setUid(5);
//        int i = sqlSession.update("com.ssm.mapper.UserMapper.updateUserById",user);
//        if(i>0){
...
//    }
    ...
    public void test5() throws Exception {
        ...
        SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(inputStream);
        SqlSession sqlSession = sqlSessionFactory.openSession();
        Student student = sqlSession.selectOne("com.ssm.mapper.StudentMapper.findStuByCardId",20110301);
